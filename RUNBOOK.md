...
1. [DLQ Count Rising Rapidly](#scenario-1-dlq-count-is-rising-rapidly)
2. [p95 Latency Exceeds SLO](#scenario-2-p95-latency-exceeds-slo--2-seconds)
3. [Schema Incompatibility Error](#scenario-3-schema-incompatibility-error)
4. [Service Not Starting](#scenario-4-service-not-starting)
5. [Kafka Consumer Lag](#scenario-5-kafka-consumer-lag-growing)
6. [Database Connection Issues](#scenario-6-database-connection-issues)
